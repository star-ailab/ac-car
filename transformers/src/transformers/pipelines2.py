...
class FeatureExtractionPipeline(Pipeline2):
    """
...
@add_end_docstrings(PIPELINE_INIT_ARGS)
class TextGenerationPipeline(Pipeline2):
    """
    ...
    def __call__(
        ...
        **generate_kwargs
        ...
        """
        extra_sampled_actions = extra_sampled_actions
        ...
        for prompt_text in text_inputs:
            ...
            with self.device_placement():
                ...
                output_sequences = self.model.generate2(input_ids=input_ids, extra_sampled_actions=extra_sampled_actions, **generate_kwargs)  # BS x SL
...
class TextClassificationPipeline(Pipeline2):
    """
...
@add_end_docstrings(PIPELINE_INIT_ARGS)
class ZeroShotClassificationPipeline(Pipeline2):
    """
...
class FillMaskPipeline(Pipeline2):
    """
...
class TokenClassificationPipeline(Pipeline2):
    """
...
@add_end_docstrings(PIPELINE_INIT_ARGS)
class QuestionAnsweringPipeline(Pipeline2):
    """
...
@add_end_docstrings(PIPELINE_INIT_ARGS)
class SummarizationPipeline(Pipeline2):
    """
...
@add_end_docstrings(PIPELINE_INIT_ARGS)
class TranslationPipeline(Pipeline2):
    """
...
@add_end_docstrings(PIPELINE_INIT_ARGS)
class Text2TextGenerationPipeline(Pipeline2):
    """
...
class ConversationalPipeline(Pipeline2):
    """
