...
def dynamic_load(dir, name, load_class=False):
    try:
        ...
        if load_class:
            ...
            spec = importlib.util.spec_from_file_location("embed_ActorCritic", "./Algorithms/Action_rep/embed_ActorCritic.py")
...
class MemoryBuffer:
    ...
    def _get(self, ids):
        #mine:
        new_ids = list(map(int, ids))
        #
        return self.s1[new_ids], self.a1[new_ids], self.dist[new_ids], self.r1[new_ids], self.s2[new_ids], self.done[new_ids]
...
if __name__ == '__main__':
    ...
    #Mine: import matplotlib.pyplot as plt
