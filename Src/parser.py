...
class Parser(object):
    def __init__(self):
        ...
        parser.add_argument("--gpu", default=0, help="GPU BUS ID ", type=int) # mine: original: default=1
    ...
    def Env_n_Agent_args(self, parser):
        ...
        parser.add_argument("--env_name", default='malware-v0', help="Environment to run the code") ## MountainCar-v0
    ...
    def Main_AC_args(self, parser):
        ...
        parser.add_argument("--buffer_size", default=int(1e3), help="Size of memory buffer (3e5)", type=int)## REMEMBER uses to be e5
